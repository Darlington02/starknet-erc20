...
from starkware.cairo.common.uint256 import (Uint256, uint256_add, uint256_add, uint256_le, uint256_lt, uint256_check, uint256_unsigned_div_rem, uint256_eq, uint256_mul)
...
# Constructor
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr} (name: felt, symbol: felt, decimals: felt, initial_supply: Uint256, recipient: felt):
...
@view
func tokens_in_custody{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(account: felt) -> (amt: Uint256):
...
@external
func request_allowlist_level{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(level_requested: felt) -> (level_granted: felt):
    let (sender_addr: felt) = get_caller_address()
    let (level_allowlist) = allowlist_level(sender_addr)
    tempvar new_level = level_allowlist + 1
...
@external
func get_tokens_from_contract{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (amtMint: Uint256):
    let (sender_addr: felt) = get_caller_address()
...
@external
func deposit_tokens{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (withdraw_amt: Uint256):

    let (sender_addr: felt) = get_caller_address()
    let (withdraw_amt: Uint256) = tokens_in_custody(sender_addr)
    let (after_custody: Uint256) = uint256_sub(withdraw_amt, withdrawn_amt)
...
@external
func deposit_tokens{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(ten_tokens_uint256: Uint256) -> (withdrawn_amt: Uint256):
...
@external
func deposit_tracker_token{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(ten_tokens_uint256: Uint256) -> (withdrawn_amt: Uint256):